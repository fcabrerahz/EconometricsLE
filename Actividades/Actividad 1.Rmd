---
title: "Actividad 1. Econometría LECO"
output:
...
summary(y)
```
h. Demuestre formalmente (matemáticamente) que $\bar{Y} = \bar{\hat{Y}}$ 
...
d.	¿Qué supuesto de Gauss-Markov estamos violando y por qué? 
