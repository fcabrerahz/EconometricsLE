...
**GitHub** es donde entregas tu trabajo y donde queda registrado tu proceso. Cada PS tiene su propio repositorio privado que el profesor y el asistente pueden ver en tiempo real. **No se aceptan entregas por correo.**
...
Un `.Rmd` que no compile descuenta 20 puntos del total del PS.

**3. Commits mínimos**
Debes realizar **mínimo 3 commits en días distintos** antes de tu entrega final. Los commits deben incluir mensajes descriptivos que reflejen tu avance. Un repositorio con un solo commit, por ejemplo, en la fecha de la entrega, recibe 0 puntos en el criterio de proceso, independientemente de la calidad del resultado.
...
**¿Dónde se usa?**
En la pestaña **"Issues"** de tu repositorio. Abre un issue llamado `Consultas PS` al inicio de cada PS y usa ese hilo para todas tus consultas.
...
- Usar IA para comprender la sintaxis de funciones específicas.
...
El historial de commits, las consultas al bot y el patrón de trabajo a lo largo del tiempo son evidencia de que el trabajo es tuyo. Un código de calidad perfecta entregado en un solo commit, sin ninguna consulta al bot ni al asistente, es una señal de alerta.

El uso de IA sin comprensión se detecta en el examen. Los PS son prácticas sobre lo que serán los exámenes individuales, en papel, y sin computadora.

---

## Rol del asistente de profesor

El asistente conduce un **laboratorio de 1.5 horas cada semana** dedicado al PS en curso. Asistir al laboratorio es la mejor manera de avanzar en el PS con apoyo directo. **La asistencia es obligatoria**
